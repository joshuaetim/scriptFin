...
@section('content')
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><a href="{{url('/admin')}}">Dashboard</a> / Support Tickets</h4>
                    ...
                    @foreach ($tickets as $ticket)
                        ...
                        <div class="modal-content">
                            ...
                            @else
                                ...
                                <form action="{{ url('replySupport') }}" id="replyForm{{$ticket->id}}" method="POST">
                                    @csrf
                                    <div id="formID{{$ticket->id}}">
                                        <input type="hidden" name="support" value="{{$ticket->id}}">

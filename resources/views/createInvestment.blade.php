...
@section('content')
    <div class="col-12 m-t-30">
        <h4 class="m-b-0">Provide Donation</h4>
        <br>
        <div class="card w-100" style="margin-left: auto; margin-right: auto; width: 90%;">
            <div class="card-body">
                ...
                <h3 class="card-title" style="color:darkslategrey; font-size:2rem; text-align: center;">Profit:
                    <span id="profit">0.00</span> NGN</h3>
                <h3 class="card-title" style="color:darkslategrey; font-size:2rem; text-align: center;">Total Yield:
                <span id="roi">0.00</span> NGN</h3>

                <form action="{{ route('addInvestment') }}" name="" id="investForm" method="post">
                    @csrf
                <small>
                    Amount:</small>
                ...
                <small>Minimum is NGN5000 | Maximum is NGN200,000</small>
                <small id="alert-donation" class="personalAlert"></small>
                <br><br><br><br>
                <button type="submit" class="btn btn-lg btn-block btn-outline-primary"
                    style="width: 80%; margin-left: auto; margin-right: auto;" id="provide__donation">Provide
                    Donation
                </button>
                </form>
                </br>
